...
It can be used in any Starlark application, not necessarily one that uses skycfg itself.
...
>>>
>>>
>>> # Continue execution. Notice that the change to variable 'closure' is maintained.
>>> cont()
[42, 1]
```
